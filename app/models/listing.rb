class Listing < ActiveRecord::Base
  ...
  def self.import_listing(title, year, type, xl_data) # type must be 'movie', 'series', or 'episode'
  puts xl_data
    title = title.to_s
    ...
    url = "http://www.omdbapi.com/?#{URI.encode_www_form('t' => search_title) }&#{URI.encode_www_form('y' => year) }&#{URI.encode_www_form('type' => type)}"
    begin
